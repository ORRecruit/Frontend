    ...
    <>
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
          <div className="w-full p-6 mx-auto bg-white shadow sm:max-w-xl lg:col-span-6 sm:p-8">
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-300">
              ...
              <a
                href="#"
                className="font-medium text-primary-600 hover:underline text-orange sm:ml-2"
              >
                Login here
              </a>
              .

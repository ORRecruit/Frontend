    ...
    <div className="fixed top-[60px] sm:left-[272px] w-[-webkit-fill-available]">
      <section className="w-full h-screen bg-gray-50 dark:bg-gray-900 pt-2">
        <div className="w-full px-4 mx-auto">
          ...
          <div className="flex items-center justify-center w-full mt-4 bg-white">
            <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer dark:border-gray-600 dark:hover:border-gray-500 bg-white">

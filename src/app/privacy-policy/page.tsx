    ...
    <>
      ...
      <div className="container mx-auto my-5 p-5 bg-white shadow-lg rounded-lg lg:w-[70%]">
        ...
        <div>
          ...
          <div className="pt-6 pb-8 mb-4">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-3">Administered by: Us</p>
              <p className="text-gray-600">
        ...
        <div className="mx-auto my-8">
          <h1 className="text-2xl font-bold mb-4">Use of Your Personal Data</h1>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-5 mb-6">
            ...
            <li className="mb-2">
              To manage Your Account: To create and manage your account on our
              platform.
            </li>
            <li className="mb-2">
              To Screen and Match for related Job: To process your job
              applications and assess your suitability for opportunities with
            ...
            <li className="mb-2">
              To contact You: To contact you regarding job opportunities, career
              development resources, and other relevant information (if you
            ...
            <li className="mb-2">
              Sharing with Recruiters: To share your resume and relevant
              information with potential employers, based on your job interests
          ...
          <ul className="list-disc pl-5 mb-6">
            <li className="mb-2">
              With Recruiters: We may share your information with Organization
              where your resume matches the requirements to initiate interview
              and hiring process.
            </li>
            <li className="mb-2">
        ...
        <div className="mx-auto my-8">
          <h2 className="font-bold text-xl mt-5">Delete Your Personal Data </h2>
        ...
        <div className="mx-auto my-8">
          ...
          <div>
            <h2 className="font-bold text-xl mt-5">Business Transactions</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mt-5">Law enforcement</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mt-5">Other legal requirements</h2>
        ...
        <div>
          <h2 className="font-bold text-xl mt-5">Children's Privacy </h2>
        ...
        <div>
          <h2 className="font-bold text-xl mt-5">Links to Other Websites </h2>

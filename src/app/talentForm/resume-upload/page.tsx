          ...
          <div className="w-full p-6 mx-auto bg-white sm:max-w-xl lg:col-span-6 sm:p-8">
            ...
            <div className="">
              ...
              <div className="flex mt-2">
                <button className="w-[47%] mx-auto bg-primary-orange focus:ring-4 focus:outline-none focus:ring-primary-300 font-base rounded-lg text-sm px-5 py-2.5 text-center text-white">
                  Upload Your Resume
                </button>
                <button

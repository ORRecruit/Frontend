  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 border border-red-400"
      >
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Job Board</span>
              </a>
            </li>
            <li>
              <a
